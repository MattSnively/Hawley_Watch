---
title: "Hawley Calls It 'Voter ID.' The SAVE Act Is Something Else Entirely."
date: "2026-03-18"
bucket: "receipt"
topic: ["democracy", "voting", "elections"]
...
contextScore: 18
rating: "misleading"
contradictionType: "framing-deception"
contradictionSummary: "Hawley uses the popularity of 'voter ID' (~80% support) to sell the SAVE Act, which actually requires documentary proof of citizenship to register to vote — a fundamentally different and far more burdensome requirement that could affect 21.3 million citizens who lack passports or birth certificates. His claim that Democrats oppose it because they 'want illegals to vote' is unsupported by evidence; non-citizen voting is already a federal crime and occurs at negligible rates."
sources:
  ...
  - "Georgia Secretary of State (2022 Audit)"
  - "OpenSecrets"
  - "CNBC"
  - "SSRS / VoteRiders / UMD-CDCE National Survey (2023)"
  - "5Calls.org"
relatedDonors: []
...
|---|---|---|
| **When** | At the polls on Election Day | At voter registration (weeks or months before) |
| **What you show** | Photo ID (driver's license, state ID) | Documentary proof of U.S. citizenship (passport, birth certificate, naturalization certificate) |
| **What it verifies** | Your identity — "you are who you say you are" | Your citizenship status — "you are a U.S. citizen" |
| **Who's affected** | Anyone without a basic photo ID | Anyone without citizenship documents readily available |
| **Scale of burden** | Most people have a driver's license | 21.3 million U.S. citizens lack ready access to a passport or birth certificate |
| **Existing precedent** | 36+ states already require some form of voter ID | Arizona's attempt was partially struck down in *Arizona v. Inter Tribal Council* (2013) |
...
<!-- Mix of half-truths and false claims. The SCOTUS and Missouri claims have kernels of truth; the non-citizen voting claims do not. -->
...
<!-- Hawley is a Yale Law grad and former state AG. The conflation of voter ID with the SAVE Act is a deliberate rhetorical choice. -->
...
<!-- The omissions are extensive and one-directional. Every piece of missing context would weaken his argument. -->

| Topic | What Hawley Said | What He Left Out |
|-------|------------------|------------------|
| **The SAVE Act** | Called it "voter ID" in all three tweets | The SAVE Act requires documentary proof of citizenship to *register*, not photo ID at the polls. A 2023 national survey by SSRS (n=2,386) found 9.1% of voting-age citizens — 21.3 million people — lack ready access to the required documents; 3.8 million lack them entirely. 11% of citizens of color vs. 8% of white citizens are affected. Disproportionately burdens elderly, low-income, rural, and minority Americans — including older Black Americans born in the Jim Crow South where birth records were poorly kept, and Native Americans on reservations with incomplete records. |
...
| **Non-citizen voting** | Implied it is a major problem requiring new legislation | Already a federal crime (18 U.S.C. § 611). Heritage Foundation database: a handful of cases out of billions of ballots. Georgia 2022 audit: zero successful non-citizen votes out of 4.8 million. Every major study — including from conservative organizations — confirms it is negligibly rare. |
| **Existing safeguards** | Implied none exist | Voter registration already requires a sworn citizenship attestation under penalty of perjury. States use the DHS SAVE database, SSN matching, REAL ID systems, and ERIC data sharing. These systems caught every non-citizen who attempted to register in Georgia's audit. |
| **His own record** | Positioned himself as an election security champion | Was the first senator to object to the 2020 Electoral College certification — an action that *undermined* confidence in election outcomes without evidentiary basis. Opposed the For the People Act, the John Lewis Voting Rights Advancement Act, and election cybersecurity funding. His "election security" agenda is exclusively about voter eligibility restrictions, not the infrastructure and cybersecurity measures experts prioritize. |
...
*Source: [OpenSecrets — Josh Hawley Campaign Finance](https://www.opensecrets.org/members-of-congress/josh-hawley/summary?cid=N00041620)*
...
- [Crawford v. Marion County Election Board, 553 U.S. 181 (2008) — Supreme Court](https://supreme.justia.com/cases/federal/us/553/181/)
- [SAVE Act (H.R. 8281) — Congress.gov](https://www.congress.gov/bill/118th-congress/house-bill/8281)
- [Veasey v. Abbott — Texas Voter ID (5th Circuit)](https://www.brennancenter.org/our-work/court-cases/veasey-v-abbott)
- [NAACP v. McCrory — North Carolina Voter ID (4th Circuit)](https://www.brennancenter.org/our-work/court-cases/naacp-v-mccrory)
- [21.3 Million American Citizens Don't Have Ready Access to Citizenship Documents — Brennan Center for Justice (June 2024)](https://www.brennancenter.org/our-work/analysis-opinion/213-million-american-citizens-voting-age-dont-have-ready-access)
- [Everything to Know About the SAVE America Act Voter ID Bill — CNBC (March 17, 2026)](https://www.cnbc.com/2026/03/17/save-america-act-voter-id-trump-senate.html)
...
- [Noncitizen Voting: The Missing Evidence — Cato Institute](https://www.cato.org/blog/noncitizen-voting-missing-evidence)
- [Georgia Secretary of State 2022 Noncitizen Audit](https://sos.ga.gov/news/secretary-raffenspergers-noncitizen-audit-confirms-no-noncitizens-voted-georgia)
- [Americans Broadly Support Voter ID Laws — Gallup](https://news.gallup.com/poll/194741/four-five-americans-support-voter-laws-early-voting.aspx)
- [Americans' Views on Voting and Elections — Pew Research](https://www.pewresearch.org/politics/2023/07/12/voter-id-other-voting-policies/)
- [18 U.S.C. § 611 — Voting by Aliens (Federal Law)](https://www.law.cornell.edu/uscode/text/18/611)
- [OpenSecrets — Josh Hawley Campaign Finance](https://www.opensecrets.org/members-of-congress/josh-hawley/summary?cid=N00041620)
